...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Cardápio IFRN - Cadastro de Alimentos</title>
        </head>
    <body>
        ...
        <div id="containerMain" class="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="boxUser" class=" ml-auto">
                            <p class="text-center text-dark m-auto">Servidor</p>
                            <img src="imgs/servidor.jpeg" class="img-fluid m-auto">
                        </div> 
                    </div>
                </div>
            </div>
            <div id="mainBody" class="mainBody col-12">
                <div class="row">
                    <div id="navleftServ" class="navLeft col-sm-4 col-md-4">
                        <nav class="navbar-nav expand-sm">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                  <a class="nav-link texto_grandeServ" href="HomeServidor.html">
                                      Home
                                    </a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link texto_grandeServ" href="cadastrodealimentos.html"
                                  >Cadastrar alimentos
                                </a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link texto_grandeServ" href="#">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link texto_grandeServ" href="mensagem.html">
                                        Mensagem
                                    </a>
                                  </li>
                              </ul>
                    ...
                    <div id="homeServ" class="home col-sm-8 col-md-8">
                        <div class="container">
                            <div class="row">
                                <div class="textTop col-12">
                                    <h1 class="text-center text-light display-3 m-auto col-12 mt-3 mb-5">Cadastrar alimento</h1>
                                </div>
