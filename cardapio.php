...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Cardápio IFRN - Cardápio</title>
        </head>
    <body>
        ...
        <div id="containerMain" class="">
            ...
            <div id="mainBody" class="mainBody col-12">
                <div class="row">
                    ...
                    <div id="home" class="home col-sm-8 col-md-8 bg-white">
                        <div class="container">
                            <div class="row">
                                <div class="textTop col-12">
                                    <h1 class="text-center text-danger display-3 m-auto col-12 mt-3 mb-5">Refeições da semana</h1>
                                </div>
                                <div class="card mt-3 mb-3">
                                    <div class="card-body">
                                        ...
                                        <img src="https://d1uz88p17r663j.cloudfront.net/original/2b76e99abc4136ccf26008c1c387023f_Bolo-de-cenoura-com-cobertura-de-brigadeiro-receitas-nestle.jpg" alt="">
                                        <p class="card-text">Bolo de cenoura</p>
                                    </div>
                                </div>
                                <div class="card mt-3 mb-3">
                                    <div class="card-body">
