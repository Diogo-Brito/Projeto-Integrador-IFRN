                        ...
                        <div class="container">
                            <div class="row">
                                <div class="textTop col-12">
                                    <h1 class="text-center text-danger display-3 m-auto col-12 mt-3 mb-5">Destaques desta semana</h1>
                                </div>
                                <div class="card mt-3 mb-3">
                                    <div class="card-body">
                                        <h1 class="card-title text-center">
                                           Confira o que teremos hoje no almoço
                                        </h1>
                                        <img src="https://img2.gratispng.com/20180917/cjh/kisspng-bauru-dish-lunch-fish-food-5b9f4d9d98d018.7019922415371667496259.jpg" alt="">
                                        <p class="card-text">Arroz com feijão preto e frango</p>
                                    </div>
                                </div>
                                <div class="card mt-3 mb-3">
                                    <div class="card-body">
